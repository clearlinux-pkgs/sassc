...
%prep
%setup -q -n sassc-3.6.2
cd %{_builddir}/sassc-3.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625033894
...
cp %{_builddir}/sassc-3.6.2/LICENSE %{buildroot}/usr/share/package-licenses/sassc/4d640cc322117dec7f97632e6ed4319131a16ad2
%make_install
